...
| Интерфейс | Студийная компоновка: источники, микшер, этапы обработки и панель протокола; тёмные полупрозрачные панели, сине-фиолетовые акценты и локальный Manrope. Эквалайзер из 40 полос реагирует на звук плеера и замирает в тишине |
